      ...
      <main className="max-w-2xl mx-auto px-5 py-12">
        ...
        <Section title="The deal">
          ...
          <p>
            ...
            galleries, the QR studio, giveaways, a listing in Discover, and the font vault. Anyone
            who bought Premium before the current profile allowance existed keeps the deal they
            bought — we don't rewrite paid promises.
          </p>
